...
export const RevenueCard = ({
    ...
    return <div className="bg-white rounded shadow-md p-4">
        ...
        <div className="flex justify-between">
            ...
            {orderCount ? <div className="flex"><div>
                {orderCount} order(s)</div> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
